...
;; Keywords: vc
;; Version: 20141115.1126
;; X-Original-Version: 1.16
...
(defvar vc-darcs-version-string "1.17"
...
(defun vc-darcs-dir-status-files (dir files _default-state update-function)
  (let* ((dir (expand-file-name dir))
         (root (vc-darcs-root dir)))
